...
import com.acme.kunde.config.dev.UsersPopulate
import com.acme.kunde.config.security.UserId.randomUUID
...
class CustomUserDetailsService(
    ...
    init {
        logger.error("!!!CustomUserDetailsService wird erzeugt")
    }
