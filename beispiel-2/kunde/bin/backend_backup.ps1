...
function Install-MongoDB-Mailserver {
...
function Uninstall-MongoDB-Mailserver {
...
switch ($cmd) {
    'install' { Install-MongoDB-Mailserver; break }
    'uninstall' { Uninstall-MongoDB-Mailserver; break }
    'forward-mongodb' {
    ...
    default { Write-Output "$script [install|uninstall|forward-mongodb|forward-mailserver|base64]" }
}
